...
+ (BOOL)hideHUDForView:(UIView *)view afterDelay:(NSTimeInterval)interval withMessage:(NSString *)message animated:(BOOL)animated {
	MBProgressHUD *hud = [MBProgressHUD HUDForView:view];
    hud.detailsLabelText = message;
	if (hud != nil) {
		hud.removeFromSuperViewOnHide = YES;
		[hud hide:animated afterDelay:interval];
		return YES;
	}
	return NO;
}
