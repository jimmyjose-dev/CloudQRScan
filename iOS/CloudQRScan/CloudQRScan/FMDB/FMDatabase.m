...
+ (NSString *)cqrsDatabasePath{

    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    NSString *documentsDirectory = [paths objectAtIndex:0];
    NSString *dbPath = [documentsDirectory stringByAppendingPathComponent:@"DBCloudQRScan.sqlite"];
    return dbPath;
    
}

+ (id)databaseWithCustomPath{
    
    return FMDBReturnAutoreleased([[self alloc] initWithPath:[self cqrsDatabasePath]]);
}
