...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        _sharers = [[NSMutableArray alloc] initWithObjects: [[CFSharer alloc] initWithType:CFSharerTypeTwitter ], [[CFSharer alloc] initWithType:CFSharerTypeFacebook],[[CFSharer alloc] initWithType:CFSharerTypeMail], [[CFSharer alloc] initWithType:CFSharerTypePhotoLibrary], nil];
        [self setUpLayers];
    }
    return self;
}

- (id)initWithFrame:(CGRect)frame forDocument:(BOOL)document{
    self = [super initWithFrame:frame];
    if (self) {
        _sharers = [[NSMutableArray alloc] initWithObjects: [[CFSharer alloc] initWithType:CFSharerTypeTwitter ], [[CFSharer alloc] initWithType:CFSharerTypeFacebook],[[CFSharer alloc] initWithType:CFSharerTypeMail], [[CFSharer alloc] initWithType:CFSharerTypeAirPrint], nil];
        [self setUpLayers];
    }
    return self;
}
