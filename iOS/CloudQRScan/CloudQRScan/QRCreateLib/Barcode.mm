...
-(void)setupQRCode:(NSString *)code
{
    ...
    //Jimmy- Changed encoding from NSUtf8 to NSMacOSRomanStringEncoding
    ...
    [qRFile getCString:filename maxLength:[qRFile length] + 1 encoding:NSMacOSRomanStringEncoding];
    char str [[code length] + 1];
    [code getCString:str maxLength:[code length] + 1 encoding:NSMacOSRomanStringEncoding];
    ...
    const float colorMasking[6] = {222, 255, 222, 255, 222, 255};
   // const float colorMasking[6] = {1.5, 1.0, 1.5, 1.0, 1.5, 1.0};
